...
## 食用
+ 下载到本地
	+ `git clone https://github.com/bestRenekton/yiluo.git` 
+ 安装
	+ `npm i`
	+ 或者使用淘宝的`cnpm i`
+ 安装mongodb
...
## 部署docker
+ 参考 [yiluo_docker分支](https://github.com/bestRenekton/yiluo/tree/yiluo_docker)
...
源代码：[https://github.com/bestRenekton/yiluo-react](https://github.com/bestRenekton/yiluo-react)
