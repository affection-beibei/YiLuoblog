<template>
  <header>
    <div class="wrapper">
      <el-row>
        <el-col :xs="20" :sm="4" :md="4" :lg="4" :xl="4"><div class="logo">伊洛</div></el-col>
        <el-col :xs="0" :sm="20" :md="20" :lg="20" :xl="20">
          <el-menu
            ...
            <el-menu-item index="2"><router-link to="/archives"><i class="iconfont icon-archives"></i>案例</router-link></el-menu-item>
            <el-menu-item index="3"><router-link to="/categories"><i class="iconfont icon-tubiao13"></i>类型</router-link></el-menu-item>
